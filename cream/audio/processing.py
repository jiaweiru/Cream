...
class ClearVoiceProcessor(ModelBackedProcessor):
    ...
    def load_model(self):
        ...
        self.patch_checkpoint_dir(cache_root=config.model_dir)
        cv = ClearVoice(task=self.task, model_names=[self.model])
